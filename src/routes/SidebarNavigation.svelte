...
<Modal />
<nav class="list-nav p-4 relative h-full">
    {#if !$path.startsWith('/docpages')}
        ...
        <ul class="h-full flex flex-col">
            ...
            {/if}
            <li>
                <a href="/scripts" class={$path == '/scripts' ? activeBg : ""}>
                    <span class="badge">
            ...
            <li>
                <a href="/addons" class={$path == '/addons' ? activeBg : ""}>
                    <span class="badge">
            ...
            <li>
                <a href="/texture-packs" class={$path == '/texture-packs' ? activeBg : ""}>
                    <span class="badge">
            ...
            <li>
                <a href="/maps" class={$path == '/maps' ? activeBg : ""}>
                    <span class="badge">
