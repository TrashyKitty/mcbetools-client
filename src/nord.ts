...
export const nord: CustomThemeConfig = {
    name: 'nord',
    properties: {
		// =~= Theme Properties =~=
		...
		// =~= Theme Colors  =~=
		// primary | #88c0d0 
		"--color-primary-50": "237 246 248", // #edf6f8
		"--color-primary-100": "231 242 246", // #e7f2f6
		"--color-primary-200": "225 239 243", // #e1eff3
		"--color-primary-300": "207 230 236", // #cfe6ec
		"--color-primary-400": "172 211 222", // #acd3de
		"--color-primary-500": "136 192 208", // #88c0d0
		"--color-primary-600": "122 173 187", // #7aadbb
		"--color-primary-700": "102 144 156", // #66909c
		"--color-primary-800": "82 115 125", // #52737d
		"--color-primary-900": "67 94 102", // #435e66
		// secondary | #81a1c1 
		...
		// tertiary | #5e81ac 
		"--color-tertiary-50": "231 236 243", // #e7ecf3
		"--color-tertiary-100": "223 230 238", // #dfe6ee
		"--color-tertiary-200": "215 224 234", // #d7e0ea
		"--color-tertiary-300": "191 205 222", // #bfcdde
		"--color-tertiary-400": "142 167 197", // #8ea7c5
		"--color-tertiary-500": "94 129 172", // #5e81ac
		"--color-tertiary-600": "85 116 155", // #55749b
		"--color-tertiary-700": "71 97 129", // #476181
		"--color-tertiary-800": "56 77 103", // #384d67
		"--color-tertiary-900": "46 63 84", // #2e3f54
		// success | #a3be8c 
		...
		// surface | #3b4252 
		"--color-surface-50": "226 227 229", // #e2e3e5
		"--color-surface-100": "216 217 220", // #d8d9dc
		"--color-surface-200": "206 208 212", // #ced0d4
		"--color-surface-300": "177 179 186", // #b1b3ba
		"--color-surface-400": "118 123 134", // #767b86
		"--color-surface-500": "59 66 82", // #3b4252
		"--color-surface-600": "53 59 74", // #353b4a
		"--color-surface-700": "44 50 62", // #2c323e
		"--color-surface-800": "35 40 49", // #232831
		"--color-surface-900": "29 32 40", // #1d2028
